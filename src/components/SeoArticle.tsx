    ...
    >
      ...
      <div className={card}>
        ...
        <div className={`space-y-4 text-sm leading-7 ${prose}`}>
          ...
          <h2 className={`text-base font-bold mt-5 mb-1 ${darkMode ? 'text-blue-300' : 'text-blue-700'}`}>
          ...
          <h2 className={`text-base font-bold mt-5 mb-1 ${darkMode ? 'text-blue-300' : 'text-blue-700'}`}>
            The Four Pillars of Keyboard Mastery
          </h2>
          ...
          <p>
            ...
            A 1-minute test at <a
              href="https://fixedaim.com/typing-test"
              target="_blank"
              rel="noopener noreferrer"
              className={`underline underline-offset-2 font-medium ${darkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-700'}`}
            >fixedaim.com/typing-test</a> gives you a reliable WPM and accuracy score.
